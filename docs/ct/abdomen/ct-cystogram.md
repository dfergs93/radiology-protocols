...
-   __1. Clinical Summary__
    ...
    === "Acquisition Summary"
        ...
        | Bladder Filling | Contrast (During filling delay) | Standard coverage |
        | Cystogram | Contrast (After filling delay) | Iliac crests to Below bladder |
...
-   __3. IV Contrast & Injection__    
    ...
    ===   "Injection Parameters"
        ...
        | Parameter | Value |
        |-----------|-------|
        | Agent | Omnipaque 350 diluted |
        | Volume | IV: 100 mL. Bladder: 350-400 mL dilute contrast (30 mL contrast in 350 mL saline) |
        | Flow Rate | 3-4 mL/s IV |
...
### Protocol Details
  ...
  ---
    gantt
      ...
      Contrast (IV: 100 mL. Bladder: 350-400 mL dilute contrast (30 mL contrast in 350 mL saline))    :active, contrast, 00:00, 28s
      ...
      Cystogram    :done, scan4, after scan1, 15s
  ```
...
=== "Series Acquisition"
    ...
    | Bladder Filling | N/A | N/A | During filling | N/A | Fill via Foley - not scanned |
    | Cystogram | Iliac crests | Below bladder | After filling | 2 mm | Scan distended bladder |
